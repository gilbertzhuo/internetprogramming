...
import { sideBarState } from "../../recoilFiles/atom";

export default function SideBar() {
  const [sideTab, setSideTab] = useRecoilState(sideBarState);
  return (
    <Container>
      <Logo href="/">IN6206</Logo>
      <SideWrapper>
        <MenuTitle>MENU</MenuTitle>
        <SideMenu>
          <LinkItem
            to="/"
            className={sideTab === 0 ? "active" : ""}
            onClick={() => {
              setSideTab(0);
            }}
          >
